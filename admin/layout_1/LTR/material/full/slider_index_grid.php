						...
						<div class="card">
							...
							<div class="card-body">
								<div class="d-flex align-items-start flex-nowrap">
									...
									<a href="slider_show.php?id=<?$slide->id?>" class="btn btn-outline bg-grey border-grey text-grey-600 btn-icon rounded-round border-2 legitRipple"><i class="icon-eye"></i></a>
