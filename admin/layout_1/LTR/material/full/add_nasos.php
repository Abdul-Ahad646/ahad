			...
			<?php //include_once($partials.'chart.php') ?>
				...
				<div class="row">
                    ...
                    <div class="card">
			                ...
			                <div class="card-body">
			                	<form action="add_nasos_processor.php" method="post" enctype="multipart/form-data">
								<action="add_product_processor.php">
                                    ...
                                    <div class="form-group">
										...
										<input name="product_availability" type="text" class="form-control" placeholder="Availability">
									</div>
                                    <div class="form-group">
										<label>Condition</label>
										<input name="product_condition" type="text" class="form-control" placeholder="Conditon">
									</div>
